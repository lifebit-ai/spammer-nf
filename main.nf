...
log.info "jobuserid                             : ${jobuserid}"
log.info "jobteamid                             : ${jobteamid}"
log.info "jobprojectid                          : ${jobprojectid}"
log.info "resultsLoc                            : ${resultsLoc}"
log.info "workdirLoc                            : ${workdirLoc}"
